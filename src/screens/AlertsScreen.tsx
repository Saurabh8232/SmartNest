// Alerts list and severity filters.
...
export default function AlertsScreen() {
  ...
  const displayed = alerts.filter(
    a => !a.isResolved && (filter === 'all' || a.severity === filter),
  );
      ...
      {!offline && (
        <View style={styles.summaryRow}>
          {[
            ...
            {
              label: 'Total Active',
              val: alerts.filter(a => !a.isResolved).length,
      ...
      {offline ? (
        <View style={styles.emptyCard}>
          ...
          <Text style={styles.emptyDesc}>
            Set your API URL in api.ts to see live alerts
          </Text>
        </View>
      ) : displayed.length === 0 ? (
        <View style={styles.emptyCard}>
            ...
            return (
              ...
              >
                <View style={styles.alertTop}>
                  <View
                    style={[styles.alertIcon, { backgroundColor: c + '22' }]}
                  >
                  ...
                  <View style={styles.flex1}>
                    ...
                    {a.deviceName && (
                      <Text style={styles.alertDevice}>{a.deviceName}</Text>
                    )}
                  </View>
