// Digital board relay control screen.
...
export default function DigitalBoardScreen() {
  ...
  const params = [
    {
      ...
      value: `${board.digitalCurrent.toFixed(2)}`,
      unit: 'A',
      icon: 'activity',
    ...
    },
    {
      ...
      value: `${board.digitalEnergyKwh.toFixed(3)}`,
      unit: 'kWh',
  ...
  const activeIndicatorColor = isRelayLocked
    ? colors.warning
    : relayStatusColor;
      ...
      {relay === null ? (
        <View style={styles.emptyCard}>
          ...
          <Text style={styles.emptyTitle}>
            {offline ? 'Backend not connected' : 'No relay data'}
          </Text>
          <Text style={styles.emptyDesc}>
            {offline
              ? 'Check your server connection'
              : 'Digital Board relay will appear here'}
          </Text>
        </View>
      ) : (
        <View
        ...
        >
          <View style={styles.relayTop}>
            <View
              style={[
                ...
                { backgroundColor: activeIndicatorColor + '22' },
              ]}
            >
              <Icon
                name="toggle-right"
            ...
            <View style={styles.flex1}>
              <Text style={styles.relayName}>
                {relay.name || 'Digital Board Relay'}
              </Text>
            ...
            <TouchableOpacity
              ...
              style={[
                styles.lockBtn,
                {
                  backgroundColor: isRelayLocked
                    ? colors.warning + '22'
                    : colors.secondary,
                },
                commandPending && styles.disabledBtn,
              ]}
              hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}
            >
              <Icon
                name={isRelayLocked ? 'lock' : 'unlock'}
                size={14}
                color={isRelayLocked ? colors.warning : colors.mutedForeground}
              />
            </TouchableOpacity>
            <Switch
              value={relay.isOn}
              ...
              disabled={
                isRelayLocked || relay.status === 'offline' || commandPending
              }
          ...
          <View style={styles.relayMetrics}>
            <View style={styles.relayMetric}>
              ...
              <Text
                style={[styles.relayMetricValue, { color: colors.primary }]}
              >
            ...
            <View style={styles.relayMetric}>
              ...
              <Text style={[styles.relayMetricValue, { color: colors.accent }]}>
                {relay.power.toFixed(0)} W
              </Text>
            </View>
            <View style={styles.metricDivider} />
            <View style={styles.relayMetric}>
      ...
      {offline && (
        <View style={styles.offlineNote}>
          ...
          <Text style={styles.offlineNoteText}>
            No backend connected — electrical data and relay status unavailable
          </Text>
        </View>
      )}
