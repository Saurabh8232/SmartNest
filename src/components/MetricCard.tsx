...
export default function MetricCard({ label, value, unit, icon, accentColor = colors.primary }: Props) {
  return (
    <View style={[styles.card, { borderLeftColor: accentColor }]}>
      <View style={[styles.iconBadge, { backgroundColor: accentColor + '22' }]}>{icon}</View>
...
const styles = StyleSheet.create({
  card: {
    ...
    borderColor: colors.border, borderLeftWidth: 3, padding: 14,
  ...
  label: { fontSize: 12, fontWeight: '500', color: colors.mutedForeground, marginTop: 2 },
});
